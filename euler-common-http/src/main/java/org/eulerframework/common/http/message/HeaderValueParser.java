...
public interface HeaderValueParser {
     ...
     */
    HeaderElement parseHeader(CharSequence buffer, ParserCursor cursor);
     ...
     */
    Param[] parseParameters(CharSequence buffer, ParserCursor cursor);
     ...
     */
    Param parseParam(CharSequence buffer, ParserCursor cursor);
