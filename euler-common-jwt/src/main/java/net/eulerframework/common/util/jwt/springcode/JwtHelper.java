...
import static net.eulerframework.common.util.jwt.springcode.JwtAlgorithms.sigAlg;
import static net.eulerframework.common.util.jwt.springcode.codec.Codecs.b64UrlDecode;
import static net.eulerframework.common.util.jwt.springcode.codec.Codecs.b64UrlEncode;
import static net.eulerframework.common.util.jwt.springcode.codec.Codecs.concat;
import static net.eulerframework.common.util.jwt.springcode.codec.Codecs.utf8Decode;
import static net.eulerframework.common.util.jwt.springcode.codec.Codecs.utf8Encode;
